<template>
    <div class="container create-event">
        <div class="title-step">Event Creation Wizard</div>
        <span class="sm-step mt-2 d-flex">Follow a guided process to set up your event from entering basic information
            to adding tickets and preparing it for publishing.</span>
        <form action="" class="create-event-form cr">
            <div class="row">
                <div class="col-7 pe-5">
                    <div class="form-section pt-0">
                        <div class="">
                            <div class="title-form-input">Event Information</div>
                            <div class="ds-form-input">Define the core details of your event including
                                title,
                                description, schedule, and category to clearly present what your event is
                                about.
                            </div>
                        </div>
                        <div class="">
                            <div>
                                ...
                                <input type="text" class="form-control" :class="{ 'form-control-err': v$.title.$error }"
                    ...
                    <div class="form-section">
                        <div class="">
                            ...
                            <div class="ds-form-input">Specify where your event will take place by providing
                                venue
                        ...
                        <div class="">
                            <div>
                                ...
                                <span class="warning-msg-input" v-for="err in v$.venue_name.$errors" :key="err.$uid">
                                    {{ err.$message }}
                                </span>
                            </div>
                            <div class="mt-3">
                                ...
                                <input type="text" class="form-control mb-3" placeholder="Input the venue address here"
                            ...
                            <div class="w-100 d-flex">
                                <div class="w-50 pe-3">
                                    ...
                                    <span class="warning-msg-input" v-for="err in v$.latitude.$errors" :key="err.$uid">
                                        {{ err.$message }}
                                    </span>
                                </div>
                                <div class="w-50 ps-3">
                                    ...
                                    <span class="warning-msg-input" v-for="err in v$.longitude.$errors" :key="err.$uid">
                                    {{ err.$message }}
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="form-section" style="border-bottom: none!important;">
                        <div class="">
                            ...
                            <div class="ds-form-input">Write a clear summary of your event so users
                                understand what it is about, what to expect, and its purpose.</div>
                        </div>
                        <div class="">
                            <textarea class="form-control mt-2" name="" id="" rows="15" style="resize: none;"
                                :class="{ 'form-control-err': v$.description.$error }"
                                placeholder="Enter the event description here" v-model="form.description"></textarea>
                ...
                <div class="col-5">
                    <div class="form-section pt-0">
                        <div class="">
                            ...
                            <div class="ds-form-input">Upload visual content such as images to represent
                                ...
                                <div v-if="thumbnailPreview" class="position-relative w-100">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            ...
                                            <span class="change-img-text">Click to Upload Thumbnail</span>
                                        </div>
                                        <span class="label">Upload an event cover image to represent your event.
                    ...
                    <div class="form-section">
                        <div class="">
                            ...
                            <div class="ds-form-input">Select and assign artists who will be featured or
                                participating in this event.</div>
                        </div>
                        <div class="mt-3">
                            <!-- DROPDOWN -->
                            <div class="ui multiple fluid search selection dropdown artist-dropdown">
...
const removeArtist = (id) => {
    ...
    const $dropdown = $('.ui.dropdown.artist-dropdown')
...
const submitEvent = async () => {
    ...
    try {
        ...
        const res = await eventStore.createEvent(token, formData)
        ...
        $('.ui.dropdown.category-dropdown').dropdown('clear')
        $('.ui.dropdown.artist-dropdown').dropdown('clear')
